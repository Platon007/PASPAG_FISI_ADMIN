...
<html>
    ...
    <div>
      <div class="aside">
        <ul class="nav nav_aside">
          ...
          <li>
            <a class="active" href="#">
              <div class="barra"></div>
              <p class="menu">FuncionalidadAlumno1</p>
            </a>
          </li>
          <li>
            <a href="#">
              <div class="barra"></div>
              <p class="menu">FuncionalidadAlumno2</p>
            </a>
          </li>
      ...
      <div class="article" style="padding: 10px 150px 500px 85px;">
        <div class="panel-heading" style="width: 850px; background: #CE9105; padding-top: 10px; color: white">Modulo de Alumno >> Actualizando</div>
          <center><h1>TRABAJANDO EN ACTUALIZACIONES</h1></center>
